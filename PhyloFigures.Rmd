...
p1 <- ggplot(lin1.m) + geom_line(aes(bb, value, colour=variable)) + theme(legend.position=c(.75,.75), legend.title=element_blank()) + xlab("") + ylab("Number") + scale_colour_manual(values=c("red", "green"))
...
p2 <- ggplot(lin1) + geom_line(aes(bb, l1un/l1), colour = "green") + theme(legend.position = "none") + xlab("") + ylab("Mig/Possible")
...
l1 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l1) <- c("vB", "t", "LL")
l1 <- tbl_df(l1)
l1 <- filter(l1, !is.na(LL), vB < 200, t < 10)
l1p <- ggplot(l1, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l1$LL)), values=rescale(unname(quantile(l1$LL))), guide="legend") +
...
l2 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l2) <- c("vB", "t", "LL")
l2 <- tbl_df(l2)
l2 <- filter(l2, !is.na(LL), vB < 500, t < 10)
l2p <- ggplot(l2, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l2$LL)), values=rescale(unname(quantile(l2$LL))), guide="legend") +
  #scale_y_continuous(limits=c(0, 10)) +
  #scale_x_continuous(limits=c(0, 200)) +
  theme_bw() +
  theme(text = element_text(size=20),
...
l3 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l3) <- c("vB", "t", "LL")
l3 <- tbl_df(l3)
l3 <- filter(l3, !is.na(LL), vB < 200, t < 10)
l3p <- ggplot(l1, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l3$LL)), values=rescale(unname(quantile(l3$LL))), guide="legend") +
  #scale_y_continuous(limits=c(0, 10)) +
  #scale_x_continuous(limits=c(0, 200)) +
  theme_bw() +
  theme(text = element_text(size=20),
...
l4 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l4) <- c("vB", "t", "LL")
l4 <- tbl_df(l4)
l4 <- filter(l4, !is.na(LL), vB < 650, t < 30)
l4p <- ggplot(l4, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l4$LL)), values=rescale(unname(quantile(l4$LL))), guide="legend") +
  #scale_y_continuous(limits=c(0, 10)) +
  #scale_x_continuous(limits=c(0, 200)) +
  theme_bw() +
  theme(text = element_text(size=20),
...
l5 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l5) <- c("vB", "t", "LL")
l5 <- tbl_df(l5)
l5 <- filter(l5, !is.na(LL), vB < 600, t < 30)
l5p <- ggplot(l5, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l5$LL)), values=rescale(unname(quantile(l5$LL))), guide="legend") +
  #scale_y_continuous(limits=c(0, 10)) +
  #scale_x_continuous(limits=c(0, 200)) +
  theme_bw() +
  theme(text = element_text(size=20),
...
l6 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l6) <- c("vB", "t", "LL")
l6 <- tbl_df(l6)
l6 <- filter(l6, !is.na(LL), vB < 600, t < 30)
l6p <- ggplot(l6, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l6$LL)), values=rescale(unname(quantile(l6$LL))), guide="legend") +
  #scale_y_continuous(limits=c(0, 10)) +
  #scale_x_continuous(limits=c(0, 200)) +
  theme_bw() +
  theme(text = element_text(size=20),
...
param_grid_dadi <- read.table("lin1_likelihood_grid_expansion.txt", header=TRUE)
l7 <-interp2xyz(interp(x=param_grid_dadi$nu, y=param_grid_dadi$T, z=param_grid_dadi$LL, duplicate="mean"), data.frame=TRUE)
colnames(l7) <- c("vB", "t", "LL")
l7 <- tbl_df(l7)
l7 <- filter(l7, !is.na(LL), vB < 600, t < 30)
l7p <- ggplot(l7, aes(x = vB, y = t, z = LL, fill = LL)) + 
  geom_tile() + 
  stat_contour(colour = "white", alpha=0.25, bins = 300, na.rm=TRUE) + 
  scale_fill_gradientn(colours= myPalette(20), breaks=unname(quantile(l7$LL)), values=rescale(unname(quantile(l7$LL))), guide="legend") +
  #scale_y_continuous(limits=c(0, 10)) +
  #scale_x_continuous(limits=c(0, 200)) +
  theme_bw() +
  theme(text = element_text(size=20),
